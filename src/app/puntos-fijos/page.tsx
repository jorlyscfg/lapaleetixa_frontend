...
const PuntosFijosPage = dynamic(() => import("./puntos_fijos_page"), {
  ssr: false,
  loading: () => (
    <div className="flex min-h-screen items-center justify-center bg-slate-900 text-slate-100 font-sans">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-medium tracking-wide animate-pulse">Cargando Módulo de Ventas Mayoristas...</p>
      </div>
    </div>
  ),
});
